// Word bank for the game. Kept family-friendly and reasonably well known.
export const WORDS = [
  ...
  "Cat","Cell","Centaur","Centre","Chair","Change","Charge","Check","Chest","Chick",
  ...
  "Hospital","Hotel","Ice","Iceland","India","Iron","Ivory","Jack","Jam","Jet",
  ...
  "Net","New York","Night","Ninja","Note","Novel","Nurse","Nut","Octopus","Oil",
  "Olive","Olympus","Opera","Orange","Organ","Palm","Pan","Pants","Paper","Parachute",
  "Park","Part","Pass","Paste","Penguin","Phoenix","Piano","Pie","Pilot","Pin",
  "Pipe","Pirate","Pistol","Pit","Pitch","Plane","Plastic","Plate","Platypus","Play",
  "Plot","Point","Poison","Pole","Police","Pool","Port","Post","Pound","Press",
  ...
  "Theatre","Thief","Thumb","Tick","Tie","Time","Tokyo","Tooth","Torch","Tower",
